...
impl Rc4 {
    pub fn new(key: &[u8]) -> Self {
        // Verify that key length is 40 - 2048 bits
    ...
    mod tests {
        ...
        fn ietf_40_bit_key_first_4_vectors() {
            ...
            let test_stream_240: [u8; 16] = [
                0x28, 0xcb, 0x11, 0x32, 0xc9, 0x6c, 0xe2, 0x86, 0x42, 0x1d, 0xca, 0xad, 0xb8, 0xb6,
                0x9e, 0xae,
            ];

            let test_stream_256: [u8; 16] = [
                0x1c, 0xfc, 0xf6, 0x2b, 0x03, 0xed, 0xdb, 0x64, 0x1d, 0x77, 0xdf, 0xcf, 0x7f, 0x8d,
                0x8c, 0x93,
            ];
